CREATE TABLE IF NOT EXISTS public."SysLLMProviderConfiguration" (
    ...
    "OpenAIOrganization" varchar(255),
    "OpenAIProject" varchar(255),
    "UseResponsesAPI" boolean NOT NULL DEFAULT true,
    "StoreResponses" boolean NOT NULL DEFAULT false,
    "MaxRetries" integer NOT NULL DEFAULT 2,
    "ServiceTier" varchar(20) NOT NULL DEFAULT 'auto',
    "IDResource" uuid,
