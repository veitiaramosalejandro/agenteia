...
class LLMProviderFromEnvironment(BaseModel):
    Source: Literal["runtime", "openai_search"] = Field(
        "runtime", description="runtime: copia el proveedor conversacional de LLM_PROVIDER y MODEL_NAME. openai_search: usa OpenAI con OPENAI_SEARCH_MODEL y OPENAI_API_KEY."
    )
